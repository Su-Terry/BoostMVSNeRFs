...
class Dataset:
    ...
    def build_metas(self):
        ...
        for scene in scenes:
            ...
            #     shutil.copy(image_paths[i], os.path.join(cfg.workspace, 'scannet_v2', scene, 'exported', 'color', '{}.jpg'.format(i)))
            #     shutil.copy(pose_paths[i], os.path.join(cfg.workspace, 'scannet_v2', scene, 'exported', 'pose', '{}.txt'.format(i)))
            #     shutil.copy(ixt_file, os.path.join(cfg.workspace, 'scannet_v2', scene, 'exported', 'intrinsic', 'intrinsic_color.txt'))
